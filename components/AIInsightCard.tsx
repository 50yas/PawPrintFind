...
export const AIInsightCard: React.FC<AIInsightCardProps> = ({ insight }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow flex gap-4"
    >
      ...
      <div className="space-y-1">
        ...
        <p className="text-[10px] text-slate-400/50 pt-1">
