                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <h3 className={`font-bold flex items-center gap-2 ${isRejected ? 'text-red-400' : 'text-yellow-400'}`}>
                                ...
                                {isRejected ? 'Verification Rejected' : 'Free Tier'}
                                {hasSubmittedDocs && !isRejected && <span className="text-xs bg-blue-500/20 text-blue-300 px-2 py-0.5 rounded">⏳ Verification Pending</span>}
                            </h3>
                        ...
                        >
                            {isRejected ? 'Retry Verification 📄' : (hasSubmittedDocs ? (isVerified ? 'Upgrade to Pro 🚀' : 'Pending Verification ⏳') : 'Submit Documents 📄')}
                        </button>
                    </div>
                </div>
            )}
                    ...
                    {isPro ? (
                        <>
                            <ActionCard
                                ...
                                description="Aggregate insights across all patients"
                            ...
                            <ActionCard
                                ...
                                description="Direct line to engineering team"
                        ...
                        <div className="space-y-4">
                            <ProFeatureTeaser
                                title="AI Health Analytics"
                                desc="Get aggregate insights across all your patients with advanced AI analysis"
                                icon="📊"
                                onUpgrade={() => setShowUpgradeModal(true)}
                            />
                            <ProFeatureTeaser
                                title="Priority Support"
                                desc="Direct access to our engineering team for urgent issues"
                                icon="🚀"
                                onUpgrade={() => setShowUpgradeModal(true)}
                            />
                        </div>
