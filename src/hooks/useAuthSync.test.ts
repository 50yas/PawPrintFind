...
describe('useAuthSync Hook', () => {
    ...
    it('syncs profile and redirects when logged in on home view', async () => {
    ...
    it('handles super_admin sync correctly by redirecting on home view', async () => {
    ...
    it('handles vet sync correctly by redirecting on home view', async () => {
