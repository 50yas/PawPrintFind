...
describe('useAuthSync Hook', () => {
    ...
    it('syncs profile and redirects when logged in on home page', async () => {
        ...
        // Should redirect to dashboard when on home
    ...
    it('redirects even if not on home page if it was a fresh login', async () => {
        ...
        // Current implementation redirects on fresh login regardless of current view
        expect(mockSetCurrentView).toHaveBeenCalledWith('dashboard');
    });
});