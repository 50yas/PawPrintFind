...
export const GlassCard = forwardRef<HTMLDivElement, GlassCardProps>(({
    ...
    const baseStyles = "backdrop-blur-xl bg-surface-container-low/60 border border-outline-variant shadow-2xl rounded-2xl overflow-hidden text-white outline-none ring-1 ring-white/5";
