...
export const Skeleton: React.FC<SkeletonProps> = ({
  ...
  return (
    <div
      className={`bg-white/5 relative overflow-hidden backdrop-blur-sm ${animate ? 'animate-pulse' : ''} ${variantStyles[variant]} ${className}`}
      aria-hidden="true"
      role="presentation"
    >
      {animate && (
...
export const PetCardSkeleton: React.FC<{ compact?: boolean }> = ({ compact = false }) => (
  <div className="glass-card-enhanced glass-panel rounded-3xl p-4 md:p-6 flex flex-col gap-4 border border-white/10 h-full">
