...
describe('SkeletonLoader Components', () => {
  it('Skeleton renders with custom class', () => {
    ...
    expect((container.firstChild as HTMLElement).querySelector('.animate-\\[shimmer_2s_infinite\\]')).not.toBeNull();
  });
  ...
  it('CardSkeleton renders correctly', () => {
    ...
    expect((container.firstChild as HTMLElement).querySelectorAll('.bg-white\\/5').length).toBeGreaterThan(0);
  });
