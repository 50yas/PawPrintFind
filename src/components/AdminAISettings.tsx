        ...
        <div className="space-y-8 animate-fade-in max-w-5xl mx-auto pb-28">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                {[
                    ...
                    { label: t('dashboard:admin.fallbackStatus'), value: settings.fallbackToGemini ? t('dashboard:admin.enabled') : t('dashboard:admin.disabled'), icon: '🛡️', glow: settings.fallbackToGemini ? 'neon-glow-green' : '' },
                ...
                <div className="flex justify-between items-center mb-6">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button
                            ...
                            className={`w-10 h-5 rounded-full transition-all duration-300 relative ${settings.fallbackToGemini ? 'bg-primary' : 'bg-white/10'}`}
                        >
