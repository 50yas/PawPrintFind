        ...
        <div className="space-y-8 animate-fade-in max-w-5xl mx-auto pb-28">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                {[
                    ...
                    { label: t('dashboard:admin.fallbackStatus'), value: settings.fallbackToGemini ? t('dashboard:admin.enabled') : t('dashboard:admin.disabled'), icon: '🛡️', glow: settings.fallbackToGemini ? 'neon-glow-cyan' : '' },
                ].map((stat, i) => (
            ...
            <GlassCard className="p-6 md:p-8 border-white/10 bg-black/40 scan-hover">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                    ...
                    {/* Resilience / Fallback Toggle */}
                    <div className="flex items-center gap-3 bg-white/5 px-4 py-2 rounded-xl border border-white/10">
                        <div className="flex flex-col">
                            <span className="text-[9px] font-black text-white uppercase tracking-wider">{t('dashboard:admin.fallbackToGemini')}</span>
                            <span className="text-[8px] text-slate-500 uppercase tracking-tight">Auto-recovery if primary fails</span>
                        </div>
                        <button
