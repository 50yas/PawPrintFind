        ...
        <div className="space-y-8 animate-fade-in max-w-5xl mx-auto pb-28">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                {[
                    ...
                    { label: t('dashboard:admin.fallbackStatus'), value: settings.fallbackToGemini ? t('dashboard:admin.enabled') : t('dashboard:admin.disabled'), icon: '🛡️', glow: settings.fallbackToGemini ? 'neon-glow-teal' : '' },
                    ...
                    <div className="flex items-center gap-4">
                        <label className="flex items-center gap-2 cursor-pointer group">
                            ...
                            <div
                                ...
                                className={`w-10 h-5 rounded-full transition-all duration-300 relative border ${settings.fallbackToGemini ? 'bg-primary/20 border-primary shadow-[0_0_10px_rgba(var(--color-primary),0.3)]' : 'bg-white/5 border-white/10'}`}
                            >
                                <div className={`absolute top-1 w-2.5 h-2.5 rounded-full transition-all duration-300 ${settings.fallbackToGemini ? 'left-6 bg-primary shadow-[0_0_5px_#fff]' : 'left-1.5 bg-slate-500'}`}></div>
                            </div>
                        </label>
                    </div>
                </div>
