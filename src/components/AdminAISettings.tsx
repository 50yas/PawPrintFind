            ...
            <GlassCard className="p-6 md:p-8 border-white/10 bg-black/40 scan-hover">
                ...
                <div className="mt-8 p-4 rounded-xl border border-white/5 bg-white/[0.02]">
                    <div className="flex items-center justify-between">
                        <div>
                            <h4 className="text-[10px] font-black text-white uppercase tracking-wider">{t('dashboard:admin.fallbackToGemini')}</h4>
                            <p className="text-[9px] text-slate-500 mt-1 uppercase">{t('dashboard:admin.fallbackToGeminiDesc')}</p>
                        </div>
                        <button
