...
export const AdminAISettings: React.FC = () => {
    ...
    const tasks: { id: AIModelTask; label: string }[] = [
        { id: 'vision', label: t('dashboard:admin.visionProtocol') || 'Pet Vision Protocol' },
        { id: 'visionIdentification', label: t('dashboard:admin.visionIdentificationProtocol') || 'Breed & Visual Identikit' },
        { id: 'triage', label: t('dashboard:admin.triageProtocol') || 'Triage & Emergency Protocol' },
        ...
        { id: 'matching', label: t('dashboard:admin.matchingProtocol') || 'Lost & Found Pet Matching' },
        { id: 'smartSearch', label: t('dashboard:admin.smartSearchProtocol') || 'Smart Search Parsing' },
        { id: 'blogGeneration', label: t('dashboard:admin.blogGenerationProtocol') || 'Blog Content Generation' },
    ];
