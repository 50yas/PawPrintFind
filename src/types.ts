...
export type AIModelTask = 'vision' | 'triage' | 'chat' | 'matching' | 'smartSearch' | 'healthAssessment' | 'blogGeneration' | 'visionIdentification';
...
export interface AISettings {
  ...
  modelMapping: Partial<Record<AIModelTask, string>> & Record<'vision' | 'triage' | 'chat' | 'matching', string>;
  lastUpdated: number;
  updatedBy: string;
...
export const AISettingsSchema = z.object({
  ...
  modelMapping: z.record(z.string(), z.string()).and(z.object({
    vision: z.string(),
    triage: z.string(),
    chat: z.string(),
    matching: z.string()
