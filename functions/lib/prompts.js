...
exports.getBlogGenerationParts = exports.getAIHealthCheckParts = exports.getSearchParsingPrompt = exports.getPetIdentikitPrompt = exports.getAutoFillPetDetailsPrompt = void 0;
const getAutoFillPetDetailsPrompt = (locale = 'en') => {
    return `
    ...
    **CRITICAL:**
    ...
    - If specific details (like exact age) are hard to determine, provide a best estimate based on visual cues.
    `;
};
exports.getAutoFillPetDetailsPrompt = getAutoFillPetDetailsPrompt;
const getPetIdentikitPrompt = (locale = 'en') => {
    return `
...
exports.getPetIdentikitPrompt = getPetIdentikitPrompt;
const getSearchParsingPrompt = (query) => {
    return `
    **Search Query:** "${query}"
...
exports.getSearchParsingPrompt = getSearchParsingPrompt;
const getAIHealthCheckParts = (pet, symptoms, locale = 'en') => {
...
exports.getAIHealthCheckParts = getAIHealthCheckParts;
const getBlogGenerationParts = (topic) => {
...
exports.getBlogGenerationParts = getBlogGenerationParts;
